...
pub fn insn_to_row(
    ...
    match insn {
        ...
        Insn::OpenRead {
            ...
            *root_page,
            *db as i64,
            Value::build_text(program.cursor_ref[*cursor_id].1.get_explain_description()),
            0,
            {
                let cursor_type =
            ...
            (
                ...
                *dest as i64,
                ...
                format!(
                    ...
                    get_table_or_index_name(*cursor_id),
                    &column_name
                        .map_or_else(|| format!("column {}", *column), |name| name.to_string())
                ),
            )
        }
        Insn::ColumnRange {
        ...
        Insn::Destroy {
            ...
            *is_temp as i64,
            Value::build_text(""),
            0,
            format!("root iDb={db} former_root={former_root_reg} is_temp={is_temp}"),
        ),
        ...
        Insn::SequenceBeginInnerTx {
            ...
            *saved_outer_reg as i64,
            Value::Null,
            0,
            format!("r[{path_kind_reg}] = path; r[{saved_outer_reg}] = saved outer mv_tx"),
        ),
        Insn::SequenceCommitInnerTx {
            ...
            *saved_outer_reg as i64,
            ...
            0,
            format!("commit inner tx; r[{status_reg}] = 0=Ok | 1=ConflictRetry"),
        ),
        Insn::AddType { db, sql } => (
            "AddType",
            *db as i64,
        ...
        Insn::ZeroOrNull { rg1, rg2, dest } => (
            ...
            *rg2 as i64,
            Value::build_text(""),
            0,
            format!("((r[{rg1}]=NULL)|(r[{rg2}]=NULL)) ? r[{dest}]=NULL : r[{dest}]=0"),
        ),
        Insn::Not { reg, dest } => (
            "Not",
            *reg as i64,
        ...
        Insn::IsTrue {
            ...
            *dest as i64,
            ...
            if *invert { 1 } else { 0 },
            format!(
                "r[{dest}] = IsTrue(r[{reg}], null={}, invert={})",
                *null_value as i64, *invert as i64
            ),
        ),
        ...
        Insn::IntegrityCk { data } => {
            ...
            (
                ...
                *max_errors as i64,
                ...
                0,
                format!(
                    "db={db} roots={roots:?} dropped_roots={dropped_roots:?} message_register={message_register}"
                ),
            )
        }
        ...
        Insn::UpdateTableSql {
            ...
            "UpdateTableSql",
            *entry_type_reg as i64,
            *table_name_reg as i64,
            *sql_reg as i64,
            Value::build_text(""),
            0,
            format!(
                "cache sqlite_schema.sql from r[{sql_reg}] for r[{table_name_reg}] when r[{entry_type_reg}] is table"
            ),
        ),
        Insn::DropColumn {
            db: _,
        ...
        Insn::HashBuild { data } => {
            ...
            (
                ...
                Value::build_text(format!(
                    "r=[{}] budget={}{payload_info}",
                    data.hash_table_id, data.mem_budget
                )),
                0,
                String::new(),
            )
        ...
        Insn::HashGraceNextProbe {
            ...
            *key_start_reg as i64,
            ...
            0,
            format!(
                "hash_table_id={hash_table_id} keys=r[{}]..r[{}] probe_rowid_dest=r[{probe_rowid_dest}]",
                key_start_reg,
                *key_start_reg + *num_keys - 1
            ),
        ),
