...
addition. Real-service retained-journal reconciliation and recovery at each
crash boundary remain open. Do not downgrade while a replacement journal exists.
...
checkpoint authority:  61 library tests passed
