...
already there, which is what MySQL's 1050 counts. Written without the words, a
table that is already there is still an error here, where MySQL answers 1050.
