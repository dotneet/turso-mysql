...
retained after a durable CAS with an ambiguous caller result. Real-service
recovery at each crash boundary remains open. Do not downgrade while a replacement journal exists.
...
server unit tests:      325 passed
checkpoint authority:  62 library tests passed
