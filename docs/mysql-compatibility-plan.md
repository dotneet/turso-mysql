...
`turso_mysql_server` unit suite has 325 tests, the checkpoint-authority library
...
`VACUUM` lifecycle, `LAST_INSERT_ID()`, and protocol paths remain gated. D007's registry
