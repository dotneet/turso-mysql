...
the factory, and the executor/session are dropped on close or error. Production
credential storage, a real account/privilege backend, and socket/TLS transport
are not implemented.
