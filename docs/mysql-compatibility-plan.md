...
protocol INSERT exposure requires a separate later capability; there is no
...
For D006, the next slices are the wider checked write forms, explicit exhaustion
diagnostics, `VACUUM` lifecycle, and protocol INSERT/OK exposure. D005 can proceed only
